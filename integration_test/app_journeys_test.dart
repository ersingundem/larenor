  ...
  testWidgets(
    ...
    (tester) async {
      ...
      try {
        ...
        await tapVisible(tester, find.byKey(const ValueKey('server-sign-in')));
        // Core destinations can grow without changing the resource contract.
        // Reveal the first lazy resource row instead of assuming it is already
        // inside the emulator viewport.
        await tester.scrollUntilVisible(
          room,
          200,
          scrollable: find.byType(Scrollable).last,
  ...
  testWidgets(
    ...
    (tester) async {
      ...
      try {
        ...
        await press('server-sign-in');
        // The destination section above the lazy resource list is allowed to
        // grow. Scroll to the exact authorized row before asserting it.
        await tester.scrollUntilVisible(
