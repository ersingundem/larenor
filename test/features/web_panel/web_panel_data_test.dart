...
void main() {
  test('throwing authority fails closed before any retirement or clear', () async {
    final api = Api();
  ...
  test('retirement added during native clear joins the active barrier', () async {
  ...
  test('panel registered during native clear is retired before completion', () async {
    final api = Api()..cookies = Completer<void>();
    final coordinator = WebPanelDataCoordinator(api: api);
