...
import 'home_person_models_test.dart' show fixture;
...
class PeopleHarness {
  ...
  late final HomePersonRecord target = HomePersonRecord.fromJson(
    f['beforeUpdate']['response']['person'],
  ...
  ProviderContainer makeContainer() => ProviderContainer(
    overrides: [
      ...
      homePeopleApiFactoryProvider.overrideWithValue((endpoint) {
        transports++;
...
class PeopleProbe extends ConsumerStatefulWidget {
  ...
  final PeopleHarness h;
  final bool admin, acl;
  final int pageSize;
  @override
  ConsumerState<PeopleProbe> createState() => PeopleProbeState();
}
...
class PeopleProbeState extends ConsumerState<PeopleProbe> {
  ...
  Widget build(BuildContext context) {
    ...
    if (widget.acl) {
      final c = ref.watch(
        homePersonGrantsControllerProvider((owner: h.owner, target: h.target)),
      );
      h.grants = c;
