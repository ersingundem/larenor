...
void main() {
  ...
  testWidgets('another view focus does not suspend this tablet window', (
    tester,
  ) async {
    final h = _Harness();
  ...
  testWidgets('native focus roundtrip cannot reuse a root HA confirmation', (
    tester,
  ) async {
    final h = _Harness();
  ...
  testWidgets(
    'native local audio remains playing across idle, wake, focus and background',
    (tester) async {
      final h = _Harness();
