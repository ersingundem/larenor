...
void main() {
  testWidgets('actual Core home displays permitted metadata and refresh removes revoked rows without HA', (tester) async {
    ...
    expect(find.byKey(const ValueKey('home-resources-empty')), findsOneWidget);
