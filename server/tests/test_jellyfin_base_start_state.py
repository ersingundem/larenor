...
@pytest.mark.parametrize('state,expected', [
    ...
    ({'Status':'created','Running':False,'Paused':False,'Restarting':False,'Dead':False,
      'OOMKilled':False,'ExitCode':0,
      'Error':'open /tmp/larenor-jellyfin-private/data /proc/4242/ns/private: no such file or directory'},
     'helper_base_proc_process_namespace_observed'),
    ({'Status':'created','Running':False,'Paused':False,'Restarting':False,'Dead':False,
      'OOMKilled':False,'ExitCode':0,
      'Error':'open /tmp/larenor-jellyfin-private/data /proc/4242/ns/net: no such file or directory'},
     'helper_base_proc_process_net_namespace_observed'),
    ({'Status':'created','Running':False,'Paused':False,'Restarting':False,'Dead':False,
      'OOMKilled':False,'ExitCode':0,
      'Error':'open /tmp/larenor-jellyfin-private/data /proc/4242/ns/mnt: no such file or directory'},
     'helper_base_proc_process_mnt_namespace_observed'),
    ({'Status':'created','Running':False,'Paused':False,'Restarting':False,'Dead':False,
      'OOMKilled':False,'ExitCode':0,
      'Error':'open /tmp/larenor-jellyfin-private/data /proc/4242/ns/ipc: no such file or directory'},
     'helper_base_proc_process_ipc_namespace_observed'),
    ({'Status':'created','Running':False,'Paused':False,'Restarting':False,'Dead':False,
      'OOMKilled':False,'ExitCode':0,
      'Error':'open /tmp/larenor-jellyfin-private/data /proc/4242/ns/uts: no such file or directory'},
     'helper_base_proc_process_uts_namespace_observed'),
    ({'Status':'created','Running':False,'Paused':False,'Restarting':False,'Dead':False,
      'OOMKilled':False,'ExitCode':0,
      'Error':'open /tmp/larenor-jellyfin-private/data /proc/4242/ns/pid: no such file or directory'},
     'helper_base_proc_process_pid_namespace_observed'),
    ({'Status':'created','Running':False,'Paused':False,'Restarting':False,'Dead':False,
      'OOMKilled':False,'ExitCode':0,
      'Error':'open /tmp/larenor-jellyfin-private/data /proc/4242/ns/pid_for_children: no such file or directory'},
     'helper_base_proc_process_pid_children_namespace_observed'),
    ({'Status':'created','Running':False,'Paused':False,'Restarting':False,'Dead':False,
      'OOMKilled':False,'ExitCode':0,
      'Error':'open /tmp/larenor-jellyfin-private/data /proc/4242/ns/user: no such file or directory'},
     'helper_base_proc_process_user_namespace_observed'),
    ({'Status':'created','Running':False,'Paused':False,'Restarting':False,'Dead':False,
      'OOMKilled':False,'ExitCode':0,
      'Error':'open /tmp/larenor-jellyfin-private/data /proc/4242/ns/cgroup: no such file or directory'},
     'helper_base_proc_process_cgroup_namespace_observed'),
    ({'Status':'created','Running':False,'Paused':False,'Restarting':False,'Dead':False,
      'OOMKilled':False,'ExitCode':0,
      'Error':'open /tmp/larenor-jellyfin-private/data /proc/4242/ns/time: no such file or directory'},
     'helper_base_proc_process_time_namespace_observed'),
    ({'Status':'created','Running':False,'Paused':False,'Restarting':False,'Dead':False,
      'OOMKilled':False,'ExitCode':0,
      'Error':'open /tmp/larenor-jellyfin-private/data /proc/4242/ns/time_for_children: no such file or directory'},
     'helper_base_proc_process_time_children_namespace_observed'),
    ({'Status':'created','Running':False,'Paused':False,'Restarting':False,'Dead':False,
      'OOMKilled':False,'ExitCode':0,
      'Error':'open /tmp/larenor-jellyfin-private/data /proc/4242/ns/net /proc/4243/ns/mnt: no such file or directory'},
     'helper_base_proc_process_namespaces_ambiguous'),
    ({'Status':'created','Running':False,'Paused':False,'Restarting':False,'Dead':False,
      'OOMKilled':False,'ExitCode':0,
    ...
    ({'Status':'removing','Running':False,'Paused':False,'Restarting':False,
     ...
     'helper_base_state_known_status_unclassified'),
        ...
        'proc-process-net-namespace','proc-process-mnt-namespace',
        'proc-process-ipc-namespace','proc-process-uts-namespace',
        'proc-process-pid-namespace','proc-process-pid-children-namespace',
        'proc-process-user-namespace','proc-process-cgroup-namespace',
        'proc-process-time-namespace','proc-process-time-children-namespace',
        'ambiguous-process-namespaces',
