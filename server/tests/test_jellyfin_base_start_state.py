...
@pytest.mark.parametrize('state,expected', [
    ...
    ({'Status':'removing','Running':False,'Paused':False,'Restarting':False,
     ...
     'helper_base_state_known_status_unclassified'),
        ...
        'path-error','runtime-name-only','image-path','proc-path','sys-path','runtime-path','engine-path',
        ...
        'observed-engine-image-paths','observed-engine-proc-paths','observed-engine-sys-paths',
