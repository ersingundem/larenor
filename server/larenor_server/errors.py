...
MESSAGES = {
    ...
    'capability_evidence_storage_unavailable': 'The evidence registry is unavailable.',
    ...
    'media_playback_authority_changed': 'The managed media playback authority changed. Refresh it.',
    'media_playback_item_changed': 'The selected managed media item changed. Refresh it.',
    'media_playback_target_changed': 'The selected managed playback target changed. Refresh it.',
    'media_playback_intent_unavailable': 'Create a new managed media playback intent.',
    'media_playback_intent_conflict': 'This managed media playback intent is no longer current.',
