...
from .models import AccessDecision, ActorFacts, PersonGrant, HomeScope, PersonTargetFacts


def evaluate_access(scope: HomeScope, actor: ActorFacts, target: PersonTargetFacts,
                    grant: PersonGrant | None, action: str, *,
    ...
    target = PersonTargetFacts.model_validate(target)
    if grant is not None:
        grant = PersonGrant.model_validate(grant)
