...
never retries a record left `running`. The route cannot open installation;
`installAvailable` remains false until configuration-before-create/start and
native service acceptance are proven.
