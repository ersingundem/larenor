...
| Private Arr API key | The configuration provider reads or generates its persisted `ApiKey`. Larenor has an exact-byte renderer/verifier, closed no-overwrite volume writer, journal-reverified networks-off Docker stdin effect, and retained-daemon installation runtime binding for fresh owned Sonarr/Radarr `config.xml` files. Persistent Core job/IPC and native authenticated acceptance remain closed. Do not expose a generic file editor or accept Client-supplied XML. [Renderer](../../../docs/arr-owned-config-implementation-2026-09-10.md), [writer](../../../docs/arr-config-helper-implementation-2026-09-10.md), [binding](../../../docs/arr-config-binding-implementation-2026-09-10.md), [effect](../../../docs/arr-config-effect-implementation-2026-09-10.md), [runtime](../../../docs/arr-config-runtime-implementation-2026-09-10.md), [upstream provider](https://github.com/Sonarr/Sonarr/blob/v4.0.19.2979/src/NzbDrone.Core/Configuration/ConfigFileProvider.cs). |
