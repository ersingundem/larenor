          ...
          onFocusChange: (focused) {
            ...
            WidgetsBinding.instance.addPostFrameCallback((_) {
              if (!padded.mounted ||
                  ...
                  !isCurrent() ||
                  !TickerMode.valuesOf(padded).enabled ||
                  ModalRoute.of(padded)?.isCurrent != true) {
                return;
              }
              final box = padded.findRenderObject(),
                  viewport = RenderAbstractViewport.maybeOf(
                    padded.findRenderObject(),
                  );
              ...
              final ring =
                      (box.localToGlobal(Offset.zero, ancestor: viewport) &
                              box.size)
                          .inflate(4),
                  visible = Offset.zero & (viewport as RenderBox).size;
            ...
            child: Align(
              ...
              child: ConstrainedBox(
                ...
                child: CustomScrollView(
                  key: const ValueKey('core-ha-scroll'),
                  slivers: slivers,
                ),
              ),
            ),
...
Widget coreHaBlock(List<Widget> children) => SliverPadding(
