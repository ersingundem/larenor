...
class CoreHaRoute extends ConsumerStatefulWidget {
  const CoreHaRoute({
    super.key,
    required this.title,
  ...
  final Widget Function(CoreHaOwner) builder;
  final VoidCallback? onExit;
  @override
  ConsumerState<CoreHaRoute> createState() => _CoreHaRouteState();
}

class _CoreHaRouteState extends ConsumerState<CoreHaRoute>
  ...
  Widget build(BuildContext context) {
    ...
    return CoreHaPage(
      ...
      slivers: [
        coreHaBlock([Text(AppLocalizations.of(context).coreHaRequired)]),
      ],
    );
  }
}
