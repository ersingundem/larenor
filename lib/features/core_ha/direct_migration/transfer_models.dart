...
final class CoreHaTransferReceipt {
  ...
  factory CoreHaTransferReceipt.fromJson(
    Object? raw, {
  ...
  static CoreHaTransferReceipt _parse(
    ...
    if (_id(value['requestId']) != requestId ||
        ...
        _integer(value['aclRevision']) != target.aclRevision) {
      _invalid();
    }
  ...
  bool sameCommit(CoreHaTransferReceipt other) =>
      requestId == other.requestId &&
      binding.sameBinding(other.binding) &&
      service.id == other.service.id &&
      service.name == other.service.name &&
      service.baseUrl == other.service.baseUrl;
  @override
  String toString() => 'CoreHaTransferReceipt';
}

final class CoreHaTransferPreview {
  CoreHaTransferPreview._(
    this.id,
    this.expiresInMs,
    this.commit,
    this.projection,
  ...
  factory CoreHaTransferPreview.fromJson(
    Object? raw, {
    required HomeResourceRecord target,
    required String requestId,
  }) {
    ...
    return CoreHaTransferPreview._(
      _id(value['id']),
      _integer(value['expiresInMs'], max: 60000),
      CoreHaTransferReceipt._parse(value, target, requestId),
      projection,
    );
  }
  @override
  String toString() => 'CoreHaTransferPreview';
}
