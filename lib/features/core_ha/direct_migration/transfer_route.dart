...
class CoreHaTransferRoute extends ConsumerStatefulWidget {
  const CoreHaTransferRoute({
    super.key,
    required this.title,
    required this.builder,
    required this.gateCurrent,
    this.onExit,
    this.backKey = 'core-ha-transfer-back',
  });
...
class _CoreHaTransferRouteState extends ConsumerState<CoreHaTransferRoute>
  ...
  bool _current() {
    ...
    try {
      return _foreground &&
          ...
          _home?.source == HomeSource.directLocal &&
          _home?.busy == false &&
          _home?.failure == null &&
  ...
  void didChangeDependencies() {
    ...
    if (_container == null) {
      ...
      _home?.account.addListener(_changed);
    }
  ...
  void dispose() {
    ...
    _home?.account.removeListener(_changed);
    _owner?.dispose();
    super.dispose();
  }
