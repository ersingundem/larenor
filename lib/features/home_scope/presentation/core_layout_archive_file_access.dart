...
final coreLayoutArchiveFileAccessProvider =
    Provider<CoreLayoutArchiveFileAccess>((_) => CoreLayoutArchiveFileAccess());
...
class CoreLayoutArchiveFileAccess {
  CoreLayoutArchiveFileAccess({
    ...
    Future<Uri?> Function(Uint8List, String)? saveFile,
           ...
           (() => FilePicker.pickFile(
             ...
             allowedExtensions: const ['larenor-core-layout'],
           )),
       _saveFile =
           saveFile ??
           ((bytes, name) => FilePicker.saveFile(
             fileName: name,
             bytes: bytes,
  ...
  Future<Uint8List?> pick() async {
    try {
      ...
      if (file.extension != 'larenor-core-layout') {
