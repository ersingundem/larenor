...
class HomeResourceAdminScreen extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<HomeResourceAdminScreen> createState() =>
      _HomeResourceAdminScreenState();
}

class _HomeResourceAdminScreenState
    extends ConsumerState<HomeResourceAdminScreen>
  ...
  Future<void> _submit() async {
    if (_editor == null || _saving || !_controller.canMutate || !_current()) {
      return;
    }
  ...
  Widget build(BuildContext context) {
    ...
    final rows = _controller.entries.toList()
      ..sort((a, b) {
          ...
          child: ConstrainedBox(
            ...
            child: !_current() || !_controller.canManage
                ? Padding(
                    ...
                    child: Text(l10n.homeResourceAdminRequired),
                  )
                : CustomScrollView(
                    slivers: [
                      SliverPadding(
                        ...
                        sliver: SliverToBoxAdapter(
                          child: Column(
                            ...
                            children: [
                              ...
                              Text(l10n.homeResourceAdminDescription),
                              if (message != null)
                                Padding(
                                  ...
                                  child: Semantics(
                                    ...
                                    child: Text(
                                      message,
                                      key: ValueKey(
                                        'home-resource-mutation-${outcome!.name}',
                                      ),
                                    ),
                                  ),
                                ),
                              ...
                              if (_editor == null) ...[
                                if (_controller.failure != null &&
                                    message == null)
                                  Text(l10n.homeResourcesError),
                                _button(
                                  'home-resource-admin-refresh',
                                  l10n.commonRefresh,
                                ...
                                _button(
                                  'home-resource-admin-create',
                                  l10n.homeResourceAdminCreate,
                                  _controller.canMutate
                                      ? () => _begin(_Editor.create)
                                      : null,
                                ),
                                if (_controller.loaded && rows.isEmpty)
                                  Text(l10n.homeResourcesEmpty),
                              ] else ...[
                                if (_editor == _Editor.delete) ...[
                                  Semantics(
                                    header: true,
                                    child: Text(
                                      l10n.homeResourceAdminConfirmDelete,
                                      key: const ValueKey(
                                        'home-resource-delete-confirmation',
                                      ),
                                    ),
                                  ),
                                  Text(_target!.label),
                                  const SizedBox(height: 12),
                                  Text(l10n.homeResourceAdminDeleteHint),
                                  _button(
                                  ...
                                  if (_editor == _Editor.create)
                                    Wrap(
                                      spacing: 12,
                                      children: [
                                        for (final kind
                                            in HomeResourceKind.values)
                                          _button(
                                            'home-resource-kind-${kind.name}',
                                  ...
                                  _field(
                                    'home-resource-label',
                                    l10n.homeResourceAdminLabel,
                                    _label,
                                  ),
                                  _field(
                                    'home-resource-order',
                                    l10n.homeResourceAdminOrder,
                                    _order,
                                    numeric: true,
                                  ),
                                  if (_invalid)
                      ...
                      if (_editor == null)
                        SliverList.builder(
                          ...
                          itemBuilder: (context, index) {
                            ...
                            return Padding(
                              key: ValueKey(
                                'home-resource-admin-row-${row.id}',
                              ),
                                ...
                                child: Padding(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      Text(
                                        row.kind == HomeResourceKind.room
                                            ? l10n.homeResourcesRoom
                                            : l10n.homeResourcesResource,
                                      ),
                                      Text(
                                        '${l10n.homeResourceAdminOrder}: ${row.order}',
                                      ),
                                      Wrap(
                                        spacing: 12,
                                        children: [
                                          _button(
                                            'home-resource-edit-${row.id}',
                                            l10n.homeResourceAdminEdit,
                                            _controller.canMutate
                                                ? () => _begin(
                                                    _Editor.update,
                                                    row,
                      ...
                      if (_editor == null && _controller.nextAfter != null)
                        SliverToBoxAdapter(
                          child: _button(
                            'home-resource-admin-load-more',
