  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return CupertinoPageScaffold(
      navigationBar: const CupertinoNavigationBar(
        middle: Text('Manage Integrations'),
      ),
      child: SafeArea(
        child: ListView(
          children: [
            ...
            CupertinoListSection.insetGrouped(
              ...
              children: [
                ...
                _ServiceRow(
                  ...
                  title: 'Sonarr',
                  connected: ref.watch(sonarrConnectionProvider).value != null,
                  enabled: enabled.contains(AppService.sonarr),
                  onToggle: (v) => toggle(AppService.sonarr, v),
                  onTap: () => Navigator.of(context).push(
                    CupertinoPageRoute(builder: (_) => const SonarrScreen()),
                  ),
                ),
                _ServiceRow(
                  icon: CupertinoIcons.film,
                  title: 'Radarr',
                  connected: ref.watch(radarrConnectionProvider).value != null,
                  enabled: enabled.contains(AppService.radarr),
                  onToggle: (v) => toggle(AppService.radarr, v),
                  onTap: () => Navigator.of(context).push(
                    CupertinoPageRoute(builder: (_) => const RadarrScreen()),
                  ),
                ),
                _ServiceRow(
                  icon: CupertinoIcons.music_note,
                  title: 'Lidarr',
                  connected: ref.watch(lidarrConnectionProvider).value != null,
                  enabled: enabled.contains(AppService.lidarr),
                  onToggle: (v) => toggle(AppService.lidarr, v),
                  onTap: () => Navigator.of(context).push(
                    CupertinoPageRoute(builder: (_) => const LidarrScreen()),
                  ),
                ),
                _ServiceRow(
                  icon: CupertinoIcons.book,
                  title: 'Readarr',
                  connected: ref.watch(readarrConnectionProvider).value != null,
                  enabled: enabled.contains(AppService.readarr),
                  onToggle: (v) => toggle(AppService.readarr, v),
                  onTap: () => Navigator.of(context).push(
                    CupertinoPageRoute(builder: (_) => const ReadarrScreen()),
                  ),
                ),
                _ServiceRow(
                  icon: CupertinoIcons.captions_bubble,
                  title: 'Bazarr',
                  connected: ref.watch(bazarrConnectionProvider).value != null,
            ...
            CupertinoListSection.insetGrouped(
              ...
              children: [
                _ServiceRow(
                  ...
                  title: 'Proxmox',
                  connected: ref.watch(proxmoxConnectionProvider).value != null,
