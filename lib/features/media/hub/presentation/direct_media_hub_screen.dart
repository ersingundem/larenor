...
class DirectMediaHubScreen extends ConsumerStatefulWidget {
  const DirectMediaHubScreen({super.key, this.embedded = false});
  final bool embedded;

  @override
  ConsumerState<DirectMediaHubScreen> createState() =>
      _DirectMediaHubScreenState();
}

class _DirectMediaHubScreenState
    extends MediaSessionState<DirectMediaHubScreen> {
  int _filter = 0;
