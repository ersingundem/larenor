...
class ProwlarrConnectScreen extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<ProwlarrConnectScreen> createState() =>
      _ProwlarrConnectScreenState();
}

class _ProwlarrConnectScreenState extends ConsumerState<ProwlarrConnectScreen> {
  final _urlController = TextEditingController(
    text: 'http://prowlarr.local:9696',
  );
  ...
  Future<void> _connect() async {
    ...
    try {
      await ref
          .read(prowlarrConnectionProvider.notifier)
          .signIn(
  ...
  Widget build(BuildContext context) {
    return CupertinoPageScaffold(
      navigationBar: const CupertinoNavigationBar(middle: Text('Prowlarr')),
      child: SafeArea(
        child: Center(
          child: ConstrainedBox(
            ...
            child: ListView(
              ...
              children: [
                ...
                LanDiscoverySection(
                  signature: ServiceSignatures.prowlarr,
                  onSelected: (url) =>
