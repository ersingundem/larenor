...
import '../data/fair_chore_api.dart';
import '../data/fair_chore_controller.dart';
import 'fair_chore_screen.dart';

final class FairChoreRoute extends ConsumerStatefulWidget {
  const FairChoreRoute({super.key, this.apiFactory});

  final ServerApiFactory? apiFactory;

  @override
  ConsumerState<FairChoreRoute> createState() => _FairChoreRouteState();
}

final class _FairChoreRouteState extends ConsumerState<FairChoreRoute>
  ...
  Future<void> _connect() async {
    ...
    final home = _home!;
    try {
      final api = await FairChoreAccountApi.connect(
