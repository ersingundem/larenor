...
class _ConfigurationScopeState extends State<ConfigurationScope>
  ...
  Future<void> _restorePrepared(
    ...
    if (_restoring || _handoffPending || !_active) {
        ...
        try {
          await prepared.applyAfterHandoff(
            ...
            isCurrentBoundary: () =>
                _active &&
                _restoring &&
                epoch == _boundaryEpoch &&
                identical(owner, _handoffOwner),
          );
          if (mounted) {
