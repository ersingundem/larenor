...
- [ ] 14. Kişisel sağlık/tartı — PIN/özel pencere koruması, ayrı Ölçümler/Kaynaklar ekranı, bounded read-only Health Connect ve açık HA kişi/sensör eşlemesi uygulandı. Özel varlıklar ortak ekranlardan gizlenir; v2 yedeklerde gizleme politikası korunur. Apple native/Huawei geliştirici onayı ve gerçek cihaz izin kabulü bekliyor. Android minimum API 26 oldu. [Uygulama](wellbeing-implementation-2026-09-05.md).
- [ ] 15. Fully Kiosk Browser — K00–K02'nin pencere/profil/idle temeli ve K03 ortak WebPanel ilk dilimi uygulandı. Typed kaynak/köken, yaşam döngüsü, yükleme/yeniden deneme sınırları test edildi. Yönetilen DPC, ileri tarayıcı/ortam içerikleri, sensörler ve uzaktan yönetim kalan ayrı dilimlerdir. [WebPanel](web-panel-implementation-2026-09-05.md), [tam matris](kiosk-capabilities-research-2026-09-05.md).
...
**13–15 ve bütünlük kontrolü:** 1.913 Flutter testi, 23 Python testi ve 44 Android native testi geçti. Tam analiz ve 652 Dart dosyasının biçim kontrolü temiz; aşamaya alınmış yaklaşık 775 KB metin değişikliğinin sır taraması temiz. DeX/pencere, özel sağlık, v2 yedek gizlilik ilkesi, ortak WebPanel ve eski dashboard/Arr/Jellyseerr/Jellyfin onayları aynı pakette doğrulandı. Dört yeni gerçek-widget önizlemesi README’ye eklendi. [Tasarım ve akış kontrolü](design-and-flow-review-2026-09-05.md). Bu kanıt fiziksel cihaz veya canlı servis kabulü değildir.
