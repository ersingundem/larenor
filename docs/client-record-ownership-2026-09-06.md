...
| Jellyseerr, Bazarr, Prowlarr | Direct medya bağlantısı | 37bd4c8:151 yeni odaklı/241 ilgili test ve bağımsız inceleme geçti; tam PIN boş recovery ve eski callback reddi. Yerel birleşime alındı, yeniCI açık. Belirsiz yazı sonrası reader/boş recovery ekdüzeltmesi7553a3f:370 ilgili test ve bağımsız inceleme geçti. |
...
| Jellyfin | Direct medya bağlantısı | 3b5c51b:98 yeni/297 ilgili test ve bağımsız inceleme geçti; credential tuple ile cihaz ID ayrı, UDP bind/stop yarışları, gerçek nativefocus ve providerreload, belirsiz token kaydı recovery dahil. Yerel birleşimde, yeniCI açık. |
| Proxmox | Direct altyapı bağlantısı | 48289eb:altı alanlı tuple, açık TLS tercihi, nativefocus/providerreload ve PIN recovery;213 odaklı/665 ilgili test, %86,8 ilgili kapsam ve bağımsız inceleme temiz. Yerel birleşimde, yeniCI açık. |
...
| Dashboard WebviewTile URL ve izinler | Direct ev kartı | Kalıcı düzen Core'a otomatik taşınmaz. Ek audit, wrapper'ın Direct sahibini generic WebPanelView'e taşımadığını buldu; cold Core ve geç native callback testleriyle ayrı düzeltme açık. |
