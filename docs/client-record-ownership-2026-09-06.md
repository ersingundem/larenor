...
| Sonarr/Radarr/Lidarr/Readarr | Direct medya bağlantısı | 0298c5a: kaynak sahipliği, çok alanlı kayıt markerı, eski form/HTTP callback reddi ve açık tam kayıt/clear kurtarması;192 odaklı/547 ilgili test ve inceleme temiz. 6426d55 backup sınırıyla e4f0f15 birleşik3418 test/analiz geçti; yeniCI açık. |
| Jellyfin, Jellyseerr, Bazarr, Prowlarr, qBittorrent | Direct medya bağlantısı | URL/kullanıcı/sırlar Core registry veya Music Assistant yetkisi değildir. Sonraki pilotlar ayrı dallarda; her provider/store için Core negatif okuma/yazma/ağ ve tam UI kabulü açık. |
