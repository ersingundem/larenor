...
**Son güncelleme: 10 Eylül 2026 — qBittorrent yönetilen servis zinciri PR41 ile ana dalda. Sonarr/Radarr sahipli `config.xml` üretimi PR42 tam CI ile ana dalda; kapalı hacim yazıcısı ve current-journal kaynak bağı yerelde yeşil. Journal-bound Docker etkisi ve native kabul sıradaki kapı.**
