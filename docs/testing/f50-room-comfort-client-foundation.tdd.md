...
The authenticated Core HTTP adapter, app-shell discovery, persisted plan/readback
projection, preview/confirm worker bridge, and physical sensor/HVAC/window checks
remain later integration and **MANUAL** acceptance gates. F50 remains `pending`;
