...
| Criterion | Evidence |
| --- | --- |
| The registry and connection journeys use the shared tablet shell, localized EN/TR copy, 48 dp actions, keyboard and TalkBack semantics, and remain usable at 600/1200 logical pixels with 200% text. The registry detail is capped at 1000 px on wide DeX/tablet windows. | `areas_tablet_accessibility_test.dart`, `devices_tablet_accessibility_test.dart`, `registry_editor_tablet_accessibility_test.dart`, `connection_pane_tablet_accessibility_test.dart` |
