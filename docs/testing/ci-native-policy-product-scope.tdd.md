...
1. Changes limited to the five reviewed managed-characterization workflows,
...
The GREEN implementation uses an exact seven-path allowlist rather than a broad
...
accepted baseline is **16/125** and **0/63**.
