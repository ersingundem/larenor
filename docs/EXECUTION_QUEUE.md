F01–F63 yazılım kapısı: **0/63** (fiziksel kabul ayrı). Kalan kuyruk: **23/125 iş kanıtla tamamlandı**.
...
| B2 — Bütünleşik medya ve müzik | 4 | 3 | 0 | 1 | 0 |
...
| S07.4 | Tek kurulum durumu ve ayarlar kabulü | CI bekliyor | — |
