...
**20 Eylül 2026 · Durum: S06.5 özel bootstrap ve S06.6 doğrulanmış sonuç/kurtarma kabul edildi; sıradaki bağımlı kapı S07 birleşik dağıtımdır.** Bu belge yeni özellik seçimi
...
kuruluma açıldığı anlamına gelmez. Kalıcı volume/mount kaynakları hazırlandı;
mounted container çalıştırma ve bootstrap kabulü hâlâ ayrı kapılardır.
...
| 6 | **Kabul edildi:** tamamlama, iptal ve kurtarma | [Ortak secret-free sonuç görünümü](s06-6-recovery-status-implementation-2026-09-20.md) create/start ile servis doğrulamasını ayırır; iptal/belirsiz etki silinmez veya otomatik tekrarlanmaz. Exact PR ağacında iki mimarili bileşen kapıları geçti |
