...
_SOURCE_FILES = (
    ...
    'tool/jellyfin_managed_ci.py', 'tool/qbittorrent_managed_ci.py',
    ...
    'server/larenor_server/plugins/qbittorrent_owned_config.py',
    'server/larenor_server/plugins/qbittorrent_config_binding.py',
    'server/larenor_server/plugins/qbittorrent_config_effect.py',
    'server/larenor_server/plugins/qbittorrent_config_runtime.py',
    'server/larenor_server/plugins/qbittorrent_config_models.py',
    'server/larenor_server/plugins/qbittorrent_endpoint.py',
    'server/larenor_server/plugins/qbittorrent_managed_categories.py',
    'server/larenor_server/plugins/qbittorrent_readback.py',
    'server/larenor_server/plugins/qbittorrent_authenticated_readback.py',
    'server/larenor_server/plugins/qbittorrent_bootstrap_executor.py',
    'server/larenor_server/plugins/shared_library_consumers.py',
    'server/larenor_server/plugins/engine_stdin.py',
